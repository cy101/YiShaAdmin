...
using ETAL.Data.Repository;
using ETAL.CodeGenerator.Model;
using ETAL.Util;
...
namespace ETAL.CodeGenerator.Template
{
    public class SingleTableTemplate
    {
        ...
        public BaseConfigModel GetBaseConfig(string path, string userName, string tableName, string tableDescription, List<string> tableFieldList)
        {
            ...
            baseConfigModel.OutputConfig.OutputEntity = Path.Combine(path, "ETAL.Entity");
            baseConfigModel.OutputConfig.OutputBusiness = Path.Combine(path, "ETAL.Business");
            baseConfigModel.OutputConfig.OutputWeb = Path.Combine(path, "ETAL.Web", "ETAL.Admin.Web");
        ...
        public string BuildEntity(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using ETAL.Util;");
            sb.AppendLine();

            sb.AppendLine("namespace ETAL.Entity." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildEntityParam(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("namespace ETAL.Model.Param." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildService(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using ETAL.Util;");
            sb.AppendLine("using ETAL.Util.Extension;");
            sb.AppendLine("using ETAL.Util.Model;");
            sb.AppendLine("using ETAL.Data;");
            sb.AppendLine("using ETAL.Data.Repository;");
            sb.AppendLine("using ETAL.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using ETAL.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");

            sb.AppendLine();

            sb.AppendLine("namespace ETAL.Service." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildBusiness(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using ETAL.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using ETAL.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using ETAL.Service." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace ETAL.Business." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildController(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using ETAL.Util;");
            sb.AppendLine("using ETAL.Util.Model;");
            sb.AppendLine("using ETAL.Entity;");
            sb.AppendLine("using ETAL.Model;");
            sb.AppendLine("using ETAL.Admin.Web.Controllers;");
            sb.AppendLine("using ETAL.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using ETAL.Business." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using ETAL.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace ETAL.Admin.Web.Areas." + baseConfigModel.OutputConfig.OutputModule + ".Controllers");
            sb.AppendLine("{");
        ...
        public async Task<List<KeyValue>> CreateCode(BaseConfigModel baseConfigModel, string code)
        {
            ...
            if (!string.IsNullOrEmpty(param["CodeEntity"].ParseToString()))
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "ETAL.Entity", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityName + ".cs");
            ...
            if (!param["CodeEntityParam"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "ETAL.Model", "Param", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityParamName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeService"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "ETAL.Service", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.ServiceName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeBusiness"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "ETAL.Business", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.BusinessName + ".cs");
                if (!File.Exists(codePath))
                {
